...
const initialSyllabusData = {
  ...
  semester: "2026/1",
  matrixYear: "2026",
  logoUrl: "Sem-título-2023-08-16T104636.757.jpg", // Utilizando a imagem oficial da Afya fornecida
  workload: {
    total: 66,
    theoretical: 33,
    practical: 33,
...
export default function App() {
  ...
  const executeReset = () => {
    setSyllabus({
      ...
      semester: "",
      matrixYear: "",
      logoUrl: "Sem-título-2023-08-16T104636.757.jpg",
      workload: {
        total: 0,
        theoretical: 0,
        practical: 0,
      ...
      <header className="bg-[#D0005F] text-white p-4 shadow-lg flex flex-wrap justify-between items-center no-print">
        <div className="flex items-center gap-3">
          <div className="bg-white p-1 rounded-lg shadow-inner">
            <img src="Sem-título-2023-08-16T104636.757.jpg" alt="Afya Logo" className="h-9 object-contain" />
          </div>
          <div>
